...
let AuthGuard = class AuthGuard {
    ...
    async canActivate(context) {
        const accountTypeInDecorator = this.reflector.getAllAndOverride('accountType', [
            context.getHandler(),
            context.getClass(),
        ]);
        ...
        try {
            ...
            const { sub: id, accountType: accountTypeInAccessToken } = (0, jsonwebtoken_1.verify)(accessToken, secretKey);
